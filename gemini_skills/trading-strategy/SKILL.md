...
description: Swing detection and strike filtration specialist for NIFTY options. Use when debugging swing detection, filter pipelines, or tie-breaker logic.
---
...
3. **APPLY** rules from `.claude/rules/swing-detection-rules.md` (Note: Ensure this file exists or update path)
