...
description: Orders and position management specialist for NIFTY options. Use when managing proactive SL orders, position lifecycles, and R-multiple accounting.
---
...
2. **APPLY** rules from `references/trading-rules.md`
